...
MODULES ?= mqtt rest socket syslog web-server
...
ZIGATE_VERSION = "v2.00"
$(info ZIGATE_VERSION is $(ZIGATE_VERSION))
...
ifneq (,$(findstring debug,$(MODULES)))
	CFLAGS		+= -DDEBUG_LOG
endif
...
ifneq (,$(findstring web-server-menu,$(MODULES)))
	CFLAGS		+= -DWEBSERVER_MENU
endif
...
CFLAGS	+= -Os -ggdb -std=c99 -Werror -Wpointer-arith -Wundef -Wall -Wl,-EL -fno-inline-functions \
	...
	-DZIGATE_VERSION="ZiGate-WiFi $(ZIGATE_VERSION) with esp-link $(VERSION)"
