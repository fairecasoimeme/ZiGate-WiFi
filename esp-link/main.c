...
char* zigate_version = VERS_STR(ZIGATE_VERSION);
...
user_init(void) {
  ...
  //force initpins
  flashConfig.reset_pin    = 1; //MCU_RESET_PIN, 
  flashConfig.isp_pin      = 3; //MCU_ISP_PIN,
  flashConfig.conn_led_pin = 0; //LED_CONN_PIN, 
  flashConfig.ser_led_pin  = 2; //LED_SERIAL_PIN,
  flashConfig.swap_uart    = 1;
